var game = new Phaser.Game/*(window.width,window.height,Phaser.AUTO,'game');*/(320,505,Phaser.AUTO,'game'); //实例化game
...
game.States.preload = function(){
	this.preload = function(){
    	...
    	game.load.bitmapFont('flappy_font', 'assets/fonts/flappyfont/flappyfont.png', 'assets/fonts/flappyfont/flappyfont.fnt');//得分字体
